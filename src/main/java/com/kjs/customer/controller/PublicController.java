 ...
 * 机具管理API接口类
 */
@Api(value = "业务接口类", tags = "机具管理", description = "机具管理业务接口类")
@ApiResponses(value = {
...
public class PublicController {
    ...
    public BaseResponse join(@RequestHeader(name="Content-Type", defaultValue = "application/json") String contentType,
